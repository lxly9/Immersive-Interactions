package com.gayasslily.immersive_interactions.item;

import com.gayasslily.immersive_interactions.ImmersiveInteractions;
import com.gayasslily.immersive_interactions.item.custom.BarkItem;
import com.gayasslily.immersive_interactions.item.custom.ChiselItem;
import com.gayasslily.immersive_interactions.item.custom.PatinaItem;
import com.gayasslily.immersive_interactions.item.custom.WaxedBrushItem;
...
public class ModItems {
    ...
    public static void registerModItems() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS).register(entries -> entries.add(COPPER_PATINA));
